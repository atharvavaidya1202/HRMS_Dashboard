...
const getMockHRData = (user: User) => ({
  teamMetrics: {
    totalEmployees: user.role === 'admin' ? 247 : 124,
    activeIDPs: user.role === 'admin' ? 198 : 97,
    completionRate: 78,
    averageSkillGrow: 15,
    budgetUtilized: 65,
    trainingHours: user.role === 'admin' ? 1847 : 923,
  },
  skillGaps: [
    {
      skill: "Grid Management",
      employeesWithGap: user.role === 'admin' ? 45 : 22,
      priority: "high",
      growthNeeded: 23,
    },
    {
      skill: "Leadership",
      employeesWithGap: user.role === 'admin' ? 38 : 19,
      priority: "high",
      growthNeeded: 20,
    },
    {
      skill: "Project Management",
      employeesWithGap: user.role === 'admin' ? 32 : 16,
      priority: "medium",
      growthNeeded: 18,
    },
    {
      skill: "Renewable Integration",
      employeesWithGap: user.role === 'admin' ? 28 : 14,
      priority: "medium",
      growthNeeded: 15,
    },
  ],
  ...
  recentActivities: [
    ...
    {
      type: "completion",
      message: user.role === 'admin' ? "15 employees completed Q4 skill assessments" : "8 employees completed Q4 skill assessments",
  ...
  upcomingTasks: [
    ...
    {
      task: user.role === 'admin' ? "Approve pending mentorship matches (12)" : "Approve pending mentorship matches (6)",
      due: "2025-01-03",
      priority: "medium",
    },
    {
