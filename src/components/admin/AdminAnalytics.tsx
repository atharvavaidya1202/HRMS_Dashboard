...
export function AdminAnalytics({ user }: AdminAnalyticsProps) {
  ...
  const hrManagersAnalysis = [
    { name: 'Shashank Ponna', department: 'HR Operations', performance: 95, efficiency: 91, teamGrowth: 18, budgetROI: 142 },
    { name: 'Anjali Sharma', department: 'Talent Dev', performance: 89, efficiency: 87, teamGrowth: 15, budgetROI: 128 },
    { name: 'Ravi Patil', department: 'Learning', performance: 92, efficiency: 85, teamGrowth: 16, budgetROI: 135 },
    { name: 'Meera Singh', department: 'Compensation', performance: 88, efficiency: 82, teamGrowth: 12, budgetROI: 118 },
    { name: 'Arjun Kumar', department: 'Recruitment', performance: 91, efficiency: 89, teamGrowth: 19, budgetROI: 145 }
  ];
