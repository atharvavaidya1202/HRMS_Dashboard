...
export function AdminOverview({ user, onViewChange }: AdminOverviewProps) {
  ...
  const departmentOverview = [
    { name: 'Grid Operations', employees: 120, performance: 92, budget: '₹68.4 Cr', manager: 'Sanjay Kulkarni', status: 'Excellent' },
    { name: 'Transmission Engineering', employees: 100, performance: 89, budget: '₹54.2 Cr', manager: 'Priya Deshmukh', status: 'Good' },
    { name: 'Renewables Integration', employees: 80, performance: 94, budget: '₹42.8 Cr', manager: 'Arjun Nair', status: 'Excellent' },
    { name: 'IT & Digital', employees: 60, performance: 87, budget: '₹38.6 Cr', manager: 'Neha Kedar', status: 'Good' },
    { name: 'Human Resources', employees: 90, performance: 91, budget: '₹22.4 Cr', manager: 'Shashank Ponna', status: 'Good' },
    { name: 'Finance & Audit', employees: 50, performance: 88, budget: '₹19.4 Cr', manager: 'Ravi Kumar', status: 'Good' }
  ];
  ...
  const hrManagerPerformance = [
    { name: 'Shashank Ponna', department: 'HR Operations', managedEmployees: 100, idpCompletion: 91, performance: 'Excellent', budgetEfficiency: 87 },
    { name: 'Anjali Sharma', department: 'Talent Development', managedEmployees: 85, idpCompletion: 89, performance: 'Good', budgetEfficiency: 82 },
    { name: 'Ravi Patil', department: 'Learning & Development', managedEmployees: 75, idpCompletion: 85, performance: 'Good', budgetEfficiency: 79 }
  ];
